...
wget https://raw.githubusercontent.com/oliviazhang0809/grafana/master/nginx.conf -O /etc/nginx/nginx.conf --no-check-certificate
nginx
...
echo "Influxdb URL:     http://localhost:8004"
echo "Grafana URL:      http://localhost:8003"
